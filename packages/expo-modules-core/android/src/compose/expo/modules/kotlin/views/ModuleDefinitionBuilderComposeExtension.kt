...
class ComposeViewFunctionDefinitionBuilder<Props : ComposeProps>(
  ...
  @PublishedApi
  internal val viewType = LazyKType(classifier = ComposeFunctionHolder::class, kTypeProvider = { typeOf<ComposeFunctionHolder<*>>() })
  ...
  inline fun <reified P0, reified P1, reified P2, reified P3, reified P4> AsyncFunction(name: String) {
    deferredFunctionWithArgs(name, toArgsArray<ComposeFunctionHolder<*>, P0, P1, P2, P3, P4>())
  }
  ...
  inline fun <reified P0, reified P1, reified P2, reified P3, reified P4, reified P5> AsyncFunction(name: String) {
    deferredFunctionWithArgs(name, toArgsArray<ComposeFunctionHolder<*>, P0, P1, P2, P3, P4, P5>())
  }
  ...
  inline fun <reified P0, reified P1, reified P2, reified P3, reified P4, reified P5, reified P6> AsyncFunction(name: String) {
    deferredFunctionWithArgs(name, toArgsArray<ComposeFunctionHolder<*>, P0, P1, P2, P3, P4, P5, P6>())
  }
